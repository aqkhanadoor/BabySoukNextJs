    ...
    return (
        <div className="min-h-screen bg-[#f0f0f1] flex flex-col justify-center items-center font-sans text-[#444]">
            ...
            <p id="nav" className="mt-6 text-sm">
                {view === 'login' ? (
                    <button onClick={(e) => { e.preventDefault(); setView('lostPassword'); }} className="text-[#007cba] hover:text-[#005a87] bg-transparent border-none cursor-pointer underline">
                        Lost your password?
                    </button>
                ) : (
                    <button onClick={(e) => { e.preventDefault(); setView('login'); }} className="text-[#007cba] hover:text-[#005a87] bg-transparent border-none cursor-pointer underline">
                        Log in
                    </button>
                )}
            </p>
