...
const SecondaryHero = () => {
    ...
    useEffect(() => {
        const ref = dbRef(db, "homepage/hero2");
        ...
        const content = (
            <div className="grid place-items-center p-2">
                <div className="relative w-full max-w-7xl rounded-3xl overflow-hidden shadow-2d border-4 border-playful-foreground transition-all duration-300 group-hover:shadow-none group-hover:-translate-y-1">
                    <Image src={src} alt={`Secondary hero banner ${index + 1}`} width={800} height={500} className="w-full h-[340px] md:h-[500px] object-fill transition-transform duration-300 group-hover:scale-105" />
