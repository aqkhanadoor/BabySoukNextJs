        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/contact" className="hover:text-playful-primary transition-transform hover:translate-x-1 inline-block">Contact Us</Link></li>
              <li><Link href="/terms" className="hover:text-playful-primary transition-transform hover:translate-x-1 inline-block">Terms & Conditions</Link></li>
              <li><Link href="/privacy" className="hover:text-playful-primary transition-transform hover:translate-x-1 inline-block">Privacy Policy</Link></li>
              <li><Link href="/shipping" className="hover:text-playful-primary transition-transform hover:translate-x-1 inline-block">Shipping</Link></li>
              <li><Link href="/returns" className="hover:text-playful-primary transition-transform hover:translate-x-1 inline-block">Returns</Link></li>
              <li><Link href="/faq" className="hover:text-playful-primary transition-transform hover:translate-x-1 inline-block">FAQ</Link></li>
