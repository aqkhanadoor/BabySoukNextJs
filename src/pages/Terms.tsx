                ...
                <div className="container mx-auto px-4">
                    <div className="bg-white rounded-2xl border-2 border-black shadow-2d p-6 md:p-10 max-w-4xl mx-auto">
                        <div className="flex items-center justify-center mb-6">
                            <Waves className="w-12 h-12 text-playful-primary animate-wiggle" />
                        ...
                        <div className="prose prose-lg max-w-none font-fredoka text-playful-dark 
                            ...
                            <p className="text-sm text-playful-dark/70 mt-8">If you have any questions about these Terms & Conditions, please contact us at the email or phone number above.</p>
                        </div>
                    </div>
                </div>
            </main>
