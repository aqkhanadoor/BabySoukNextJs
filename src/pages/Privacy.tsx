        ...
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <main className="flex-1">
                <section className="container mx-auto px-4 py-12 md:py-20 max-w-4xl prose prose-sm md:prose-base dark:prose-invert">
                    <h1 className="mb-6 text-3xl md:text-4xl font-bold tracking-tight">Privacy Policy</h1>
                    ...
                    <p className="text-xs text-muted-foreground">We aim to respond to all valid requests within a reasonable timeframe.</p>
                </section>
            </main>
            <Footer />
        </div>
